...
- (void)buildUIWithFrame:(CGRect)frame {
    ...
    [self.dontShowButton setAutoresizingMask:UIViewAutoresizingFlexibleWidth];
}
...
- (void)buildFooterView {
    ...
    [self.dontShowButton.titleLabel setFont:[UIFont systemFontOfSize:14.0]];
    [self.dontShowButton addTarget:self action:@selector(dontShowAgainIntroduction) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:self.dontShowButton];
}
...
- (void)dontShowAgainIntroduction {
    [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"dont_show_again"];
