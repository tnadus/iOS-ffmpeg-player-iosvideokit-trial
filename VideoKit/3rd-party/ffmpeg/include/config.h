...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc --as='gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc' --prefix=/Users/sudanx/Desktop/proje_tv/ALL_VIDEOSTREAMSDK/TEST_ALL/ffs/ff_1.2.1/bin/iPhoneSimulator6.1-i386.sdk --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk --extra-cflags=-I../../include --extra-cflags=-I../../include/x264 --extra-ldflags=-L../../lib --extra-ldflags=-L/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator6.1.sdk/usr/lib/system --target-os=darwin --arch=i386 --extra-cflags='-arch i386' --extra-ldflags='-arch i386' --enable-cross-compile --cpu=i386 --enable-pic --disable-asm --disable-ffmpeg --disable-ffserver --disable-ffplay --disable-ffprobe --disable-doc --disable-debug --disable-stripping --enable-static --disable-bzlib --disable-avfilter --disable-avdevice --disable-postproc --disable-yasm --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-mmx --disable-vis --disable-encoders --disable-decoder=ac3 --disable-decoder=eac3 --disable-decoder=mlp --enable-demuxers --disable-muxers --disable-hwaccels --disable-bsfs --disable-devices --disable-indevs --disable-outdevs --disable-filters"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define FFMPEG_DATADIR "/Users/sudanx/Desktop/proje_tv/ALL_VIDEOSTREAMSDK/TEST_ALL/ffs/ff_1.2.1/bin/iPhoneSimulator6.1-i386.sdk/share/ffmpeg"
#define AVCONV_DATADIR "/Users/sudanx/Desktop/proje_tv/ALL_VIDEOSTREAMSDK/TEST_ALL/ffs/ff_1.2.1/bin/iPhoneSimulator6.1-i386.sdk/share/ffmpeg"
